...
static void canonicalizeFlow(const L3Info &l3, const L4Info &l4, FlowKey &conn,
                             UserKey &user) {
  conn.isIPv6 = l3.isV6;
  user.isIPv6 = l3.isV6;
...
static void updateStats(ProcessingContext &ctx, const L3Info &l3,
                        const L4Info &l4, uint64_t bytes, const FlowKey &conn,
                        const UserKey &user) {
